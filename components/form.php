            ...
            <div class="form">
                ...
                <div class="infos">
                    ...
                    <div class="genders">
                        ...
                        <br>
                        <label class ="gender" for="male">Mr</label>
                        <input type="radio" id="male" name="gender" value="Mr">
                        <label class ="gender" for="female">Ms</label>
                        <input type="radio" id="female" name="gender" value="Ms">
                        <label class ="gender" for="other">O</label>
                ...
                <div class="moreInfo">
                    ...
                    <br>
                    <select class="inputcountry" name="country" id="country">
